...
\begin{frame}{Ejemplo: SymbolTable}{Designaciones}
  ...
  \begin{itemize}
    \item Utilizaremos a las designaciones de una manera similar a la propuesta por Jackson. Además del proposito habitual de las mismas, resultarán una fuente de conocimiento para nuestro sistema de NLG.
