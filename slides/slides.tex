...
\begin{frame}{Ejemplo: SymbolTable}{}

  \begin{itemize}
  \item{
  La operación \emph{Update} (parte de la especificación para una tabla de símbolos) modela la actualización de información asociada a un símbolo perteneciente a la tabla.
  }
  \end{itemize}
