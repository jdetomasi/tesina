...
Como mencionamos anteriormente, si bien seguiremos la metodología mencionada, en este trabajo desarrollaremos las particularidades necesarias para aplicarla a nuestro problema en cuestión. En el capítulo siguiente, daremos el primer paso necesario para la construcción de este sistema realizando un análisis detallado del corpus de descripciones a fin de obtener los requerimientos necesarios para nuestro trabajo. En el capítulo \ref{cap:document_planning} estudiaremos más en detalle la etapa de \textit{document planning}, donde veremos las tareas de determinación de contenido y estructuración del documento, necesarias para atacar nuestro problema en particular. En el capítulo \ref{cap:microplanning} estudiaremos la etapa de \textit{microplanning} de nuestro sistema, donde veremos, entre otras cosas, la tarea de lexicalización resultado del conjunto de reglas recolectadas para este trabajo; las cuales introduciremos en el capítulo \ref{cap:corpus}. Finalmente, en el capítulo \ref{cap:realization} desarrollaremos un pequeño realizador lingüistico en español, necesario para la última la etapa de \textit{surface realization} de la arquitectura presentada.
